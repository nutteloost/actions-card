...
async function main() {
  ...
  while (true) {
    ...
    console.log('❌ Invalid version format. Use semantic versioning (e.g., 1.5.2 or 1.5.2-beta.1)');
  }
  ...
  try {
    ...
    console.log('\n📦 Next steps:');
    console.log('   - Create GitHub release at: https://github.com/nutteloost/actions-card/releases/new?tag=v' + newVersion);
