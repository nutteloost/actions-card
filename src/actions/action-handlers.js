 ...
 */
export function executeNavigateAction(actionConfig, hass, config, childCard) {
 ...
 * @param {Object} childCard - Child card element
 */
export function executeUrlAction(actionConfig, hass, config, childCard) {
 ...
 * @param {Object} childCard - Child card element
 */
export function executeServiceAction(actionConfig, hass, config, childCard) {
  ...
  const target =
    actionConfig.target ||
    (serviceData.entity_id ? { entity_id: serviceData.entity_id } : {});
 ...
 */
export function executeMoreInfoAction(
  actionConfig,
  hass,
  config,
  childCard,
 ...
 * @param {Object} element - Element to fire event from
 */
export function executeAssistAction(
  actionConfig,
  hass,
  config,
  childCard,
 ...
 * @param {Object} element - Element to fire event from
 */
export function executeDomEventAction(
  actionConfig,
  hass,
  config,
  childCard,
  ...
  if (actionConfig.event_type === "browser_mod" && actionConfig.event_data) {
    logDebug(
      "ACTION",
      "Firing Browser Mod compatible event:",
